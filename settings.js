 ...
 ******************************************************************************/
     ...
     * lost.
     */
    credentialSecret: "opcua-cloud-nodered-2026",
 ...
 ******************************************************************************/
    ...
    adminAuth: {
        ...
        users: [{
            username: "admin",
            password: "$2b$08$4fi/bybvu3SPBPblm09PM.Kk6XJoMLnaQsK6NyBSU06xJTX2BvHLq",
            permissions: "*"
        }]
    },

    // 允许 HTTP In 节点匿名访问（看板、代理 API 等），编辑器仍受 adminAuth 保护
    httpNodeAuth: false,
